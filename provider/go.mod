module github.com/pulumiverse/pulumi-matchbox/provider
...
require (
	github.com/poseidon/terraform-provider-matchbox v0.5.2
	github.com/pulumi/pulumi-terraform-bridge/v3 v3.52.0
...
require (
	...
	github.com/poseidon/matchbox v0.9.0 // indirect
