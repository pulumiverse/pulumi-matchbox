...
namespace Pulumiverse.Matchbox
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumiverse.Matchbox.version.txt");
    ...
    internal sealed class MatchboxResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public MatchboxResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
