# WARNING: This file is autogenerated - changes will be overwritten when regenerated by https://github.com/pulumiverse/projen-pulumi-providers
...
# `cmd/pulumi-resource-matchbox/schema.json` is valid and up to date.
...
ci-mgmt: .ci-mgmt.yaml
	go run github.com/pulumiverse/projen-pulumi-providers/provider-ci@main generate
.PHONY: ci-mgmt
